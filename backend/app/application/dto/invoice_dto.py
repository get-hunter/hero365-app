...
class InvoiceDTO(BaseModel):
    ...
    def from_entity(cls, invoice) -> 'InvoiceDTO':
        ...
        return cls(
            ...
            tax_type=invoice.tax_type.value if hasattr(invoice.tax_type, 'value') else invoice.tax_type,
            overall_discount_type=invoice.overall_discount_type.value if hasattr(invoice.overall_discount_type, 'value') else invoice.overall_discount_type,
