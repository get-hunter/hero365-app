...
from app.api.routes import auth, businesses, users, utils, business_context, middleware_health, contacts, jobs, projects, activities, scheduling, estimates, invoices, templates, products, suppliers, purchase_orders, voice_sessions, outbound_calls
...
api_router.include_router(voice_sessions.router, tags=["voice-sessions"], include_in_schema=True)
api_router.include_router(outbound_calls.router, tags=["outbound-calls"], include_in_schema=True)
