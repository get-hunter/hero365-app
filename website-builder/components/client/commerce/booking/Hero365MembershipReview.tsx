...
import { MembershipPlan, ServicePricing } from '@/lib/shared/types/membership';
    ...
    try {
      ...
      const bookingRequest = {
        ...
        service_address: {
          ...
          access_notes: state.address?.accessNotes
        },
        ...
        urgency_level: state.details?.urgencyLevel || 'normal',
