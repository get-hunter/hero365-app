...
import Hero365PromotionalBanner, { Promotion, getSeasonalPromotions } from './Hero365PromotionalBanner';
...
export default function Hero365Hero({
  businessName,
  headline,
  subheadline,
  city,
