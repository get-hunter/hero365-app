...
import type { ServiceCategory } from '@/lib/shared/types/content';
...
export default function Hero365ServicesOverview({ serviceCategories, businessName }: Hero365ServicesOverviewProps) {
