...
import type { BusinessData, Location } from '@/lib/shared/types/content';
...
export default function Hero365ContactSection({ business, locations = [] }: Hero365ContactSectionProps) {
