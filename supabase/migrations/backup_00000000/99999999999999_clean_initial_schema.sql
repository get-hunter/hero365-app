...
DROP FUNCTION IF EXISTS public.mark_expired_invitations CASCADE;
DROP FUNCTION IF EXISTS public.update_businesses_last_modified CASCADE;
DROP FUNCTION IF EXISTS public.update_departments_last_modified CASCADE;
...
DROP FUNCTION IF EXISTS public.get_default_permissions_for_role CASCADE;
DROP FUNCTION IF EXISTS public.assign_default_permissions CASCADE;
