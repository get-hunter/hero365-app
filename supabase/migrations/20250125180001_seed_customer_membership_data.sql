...
BEGIN
    ...
    (default_business_id, 'AC + Furnace Installation', 'HVAC', 4500, 'from', 'Complete HVAC system installation', 3825, 3600, 3375, ARRAY[], NULL),
    (default_business_id, 'AC + Furnace Replacement', 'HVAC', 3500, 'from', 'Replace existing HVAC system', 2975, 2800, 2625, ARRAY[], NULL),
    (default_business_id, 'Service Call (Diagnostic)', 'HVAC', 69, 'fixed', 'Professional system diagnostic', 0, 0, 0, ARRAY[], NULL),
    (default_business_id, 'Furnace Repair', 'HVAC', 199, 'from', 'Professional furnace repair service', 169, 159, 149, ARRAY[], NULL),
    (default_business_id, 'AC Repair', 'HVAC', 199, 'from', 'Professional air conditioning repair', 169, 159, 149, ARRAY[], NULL)
    ...
    (default_business_id, 'Electrical Estimate', 'Electrical', 0, 'free', 'Free electrical work estimate', 0, 0, 0),
    (default_business_id, 'Service Call (Diagnostic)', 'Electrical', 69, 'fixed', 'Electrical system diagnostic', 0, 0, 0),
    (default_business_id, 'Outlet/Switch 120V Installation/Replacement', 'Electrical', 300, 'from', 'Standard outlet or switch work', 255, 240, 225),
    (default_business_id, 'EV Charger Installation', 'Electrical', 700, 'from', 'Complete EV charger installation', 595, 560, 525),
    (default_business_id, 'Electrical Panel Replacement', 'Electrical', 2000, 'from', 'Main electrical panel replacement', 1700, 1600, 1500)
    ON CONFLICT (business_id, service_name, service_category) DO NOTHING;
    ...
    (default_business_id, 'Plumbing Estimate', 'Plumbing', 0, 'free', 'Free plumbing work estimate', 0, 0, 0),
    (default_business_id, 'Water Heater Repair', 'Plumbing', 240, 'from', 'Water heater repair service', 204, 192, 180),
    (default_business_id, '40 gal Gas Tank Water Heater Replacement', 'Plumbing', 1800, 'from', '40 gallon gas water heater replacement', 1530, 1440, 1350),
    (default_business_id, '50 gal Gas Tank Water Heater Replacement', 'Plumbing', 1950, 'from', '50 gallon gas water heater replacement', 1658, 1560, 1463),
    (default_business_id, 'Main Water Valve Replacement', 'Plumbing', 450, 'from', 'Main water shutoff valve replacement', 383, 360, 338)
    ON CONFLICT (business_id, service_name, service_category) DO NOTHING;
    ...
    (default_business_id, 'Walk-in Cooler/Walk-in Freezer Installation Estimate', 'Refrigeration', 0, 'free', 'Commercial refrigeration estimate', 0, 0, 0),
    (default_business_id, 'Walk-in Cooler/Walk-in Freezer Diagnostic', 'Refrigeration', 99, 'fixed', 'Commercial refrigeration diagnostic', 0, 0, 0),
    (default_business_id, 'Commercial Refrigerator Repair', 'Refrigeration', 199, 'from', 'Commercial refrigeration repair', 169, 159, 149)
    ON CONFLICT (business_id, service_name, service_category) DO NOTHING;
