-- =============================================
-- SEO REVENUE ENGINE - SIMPLIFIED MIGRATION
-- =============================================
-- This migration creates the essential SEO tables without dependencies
...
CREATE TABLE IF NOT EXISTS generated_seo_pages (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    business_id UUID NOT NULL, -- Reference to business (no FK constraint for flexibility)
...
-- =============================================
-- WEBSITE DEPLOYMENTS (SIMPLIFIED)
-- =============================================

-- Simple deployment tracking without business FK
CREATE TABLE IF NOT EXISTS seo_website_deployments (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    business_id UUID NOT NULL, -- No FK constraint for flexibility
...
CREATE INDEX IF NOT EXISTS idx_seo_deployments_business_status ON seo_website_deployments(business_id, status);
